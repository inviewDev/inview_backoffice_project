...
import { Container, Row, Col, Table, Form, Button, Alert, Modal } from 'react-bootstrap';
...
function UserList({ user: currentUser }) {
  ...
  const tab = searchParams.get('tab') === 'pending' ? 'pending' : 'users';
    ...
    <>
      <section className="userlist_block">
        <Container className="userlist_container">
          ...
          <UserManagementTabs activeKey={tab} canManage={isMaster} />
